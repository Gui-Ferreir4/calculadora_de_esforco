...
texto = st.text_area(
    ...
    height=250,
    placeholder="Exemplo:\n"
    placeholder="ID\t                       Componente\t Status\t    Início\t                Tempo de execução\t    Público Selecionado\t    Mais informações\n
    placeholder="684058ef31243a261fb51baa\t Origem\t     Ok\t        04/06/2025 - 11:37\t    5s\t                   10\t                     -"
)
